...
# Form implementation generated from reading ui file 'mirrorUI.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_temperature.setMaximumSize(QtCore.QSize(16777215, 60))
        font = QtGui.QFont()
        ...
        self.label_humidity.setMaximumSize(QtCore.QSize(16777215, 50))
        font = QtGui.QFont()
        font.setFamily("HelveticaNeueLT Pro 73 BdEx")
        ...
        self.label_weathericon.setMinimumSize(QtCore.QSize(120, 120))
        self.label_weathericon.setMaximumSize(QtCore.QSize(120, 120))
        ...
        spacerItem = QtWidgets.QSpacerItem(30, 40, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_head.addItem(spacerItem)
        self.verticalLayout_headR = QtWidgets.QVBoxLayout()
        self.verticalLayout_headR.setObjectName("verticalLayout_headR")
        self.label_time = QtWidgets.QLabel(self.centralwidget)
        self.label_time.setMaximumSize(QtCore.QSize(16777215, 70))
        font = QtGui.QFont()
        font.setFamily("HelveticaNeueLT Pro 73 BdEx")
        ...
        self.label_week.setMaximumSize(QtCore.QSize(16777215, 30))
        font = QtGui.QFont()
        font.setFamily("华文琥珀")
        font.setPointSize(25)
        ...
        self.label_historyhead.setMaximumSize(QtCore.QSize(16777215, 20))
        font = QtGui.QFont()
        font.setFamily("造字工房稚言体（非商用）")
        font.setPointSize(20)
        ...
        self.label_historymsg.setMinimumSize(QtCore.QSize(0, 60))
        self.label_historymsg.setMaximumSize(QtCore.QSize(16777215, 60))
        font = QtGui.QFont()
        font.setFamily("造字工房稚言体（非商用）")
        font.setPointSize(15)
        ...
        self.horizontalLayout_head.setStretch(2, 1)
...
"background-color: rgb(63, 63, 63);")
        ...
        self.horizontalLayout_center.addItem(spacerItem2)
        ...
        self.label_todohead.setMaximumSize(QtCore.QSize(16777215, 30))
        font = QtGui.QFont()
        font.setFamily("造字工房稚言体（非商用）")
        font.setPointSize(25)
        ...
        self.label_todomsg.setMinimumSize(QtCore.QSize(0, 150))
        self.label_todomsg.setMaximumSize(QtCore.QSize(16777215, 150))
        font = QtGui.QFont()
        font.setFamily("造字工房稚言体（非商用）")
        font.setPointSize(20)
        ...
        self.label_headlinesmsg.setMinimumSize(QtCore.QSize(0, 60))
        self.label_headlinesmsg.setMaximumSize(QtCore.QSize(16777215, 60))
        font = QtGui.QFont()
        font.setFamily("造字工房稚言体（非商用）")
        font.setPointSize(15)
    ...
    def retranslateUi(self, MainWindow):
        ...
        rasp_time=time.strftime('%Y年6月%d日',time.localtime())
        date=time.strftime('%H:%M:%S',time.localtime())
        
        self.label_time.setText(_translate("MainWindow", rasp_time))
        self.label_date.setText(_translate("MainWindow", date))
        #self.label_week.setText(_translate("MainWindow", "星期三"))
       # self.label_historyhead.setText(_translate("MainWindow", ""))
      #  self.label_historymsg.setText(_translate("MainWindow", ""))

        self.label_todohead.setText(_translate("MainWindow", "欢迎:"))
        self.label_todomsg.setText(_translate("MainWindow", "LOU TAIRONG"))
        self.label_headlineshead.setText(_translate("MainWindow", "今日:"))
        self.label_headlinesmsg.setText(_translate("MainWindow", "今天没事~"))
